...
export default function TopBar({
  ...
  return (
    <header className="sticky top-0 z-20 bg-slate-900 md:bg-white text-white md:text-slate-900 border-b border-slate-800 md:border-slate-200 px-4 sm:px-6 py-3 shadow-sm transition-colors">
      <div className="flex items-center justify-between gap-3">
        ...
        {/* SISI KANAN: PEMILIH TANGGAL (CUSTOM POPOVER DENGAN DOT PENANDA DATA) */}
